...
function createHeatmap(apiPath) {
    var initialRegion = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { lat: 39.50, lng: -98.35 };
    var isPolitical = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    ...
    function createUI() {
        ...
        function initMarkersBtn() {
            var btn = document.getElementById('markersBtn');
            btn.addEventListener('click', function () {
                fetchMarkers();
            });
            return btn;
        ...
        var hbtn = initHeatmapBtn();
        var mbtn = initMarkersBtn();
